...
class LawyersCard extends StatelessWidget {
  const LawyersCard({super.key, this.onTap, this.icon, this.iconColor, this.lawyerName, this.aboutLawyer, this.imageUrl, this.rating, this.education, this.experience, this.courts, this.city, this.state, this.callCharge, this.courtCharge});
  ...
  final String? rating,education,experience,courts,city,state,callCharge,courtCharge;
                    ...
                    child: Card(
                      ...
                      child: Column(
                        children: [
                              ...
                              ListTile(
                                ...
                                leading: CircleAvatar(
                                  ...
                                  backgroundColor: Colors
                                      .black, //Color.fromARGB(255, 10, 63, 105),
                                  child: imageUrl != null? Image.asset(imageUrl!) : const Icon(Icons.account_circle,
                          ...
                          Stack(children: [
                            ListTile(
                              title: Text("Education : ${education!}\n"
